...
for _ in range(inin()):
    ...
    moments = []
    for i in range(h):
        if '3' in list(str(i)) or '4' in list(str(i)) or '6' in list(str(i)) or '7' in list(str(i)) or '9' in list(str(i)):
            continue
        for j in range(m):
            if '3' in list(str(j)) or '4' in list(str(j)) or '6' in list(str(j)) or '7' in list(str(j)) or '9' in list(str(j)):
                continue
            if len(str(i))==1:
                i = '0' + str(i)
            if len(str(j))==1:
    ...
    if nothing==1 or (int(hh)==h-1 and int(mm)==m-1):
        print('00:00')
        continue
    print(rh+':'+rm)
